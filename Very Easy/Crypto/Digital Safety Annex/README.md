...
annex.sign("ElGamalSux", FLAG, HTB_PASSWD)
```
so we can brute forcing the value K and put in practice this idea looks like this
```python
class Solver:
...
p = 
q = 20519229739599041555407320433119797781635340775675043194826066539273
g = 
solver = Solver(g, p, q)
target_r = 4559594737218422332478833505880630464105233638196418246696677103439 # Valor objetivo que quieres encontrar
